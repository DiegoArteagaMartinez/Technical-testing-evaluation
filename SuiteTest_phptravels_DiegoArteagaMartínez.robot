...
${password_Test_04}   I'm gonna fail anywy
...
#Do a search, Open a PDP and check the information that it should contains
Flight serch
...
#Check that you log in unsuccessfully with an existing account
Unsuccessfully Login
...
#Check that when you press the flights button you go to the correct page
Check Flights Content
...
#Check that when you press the boats button you go to the correct page
Check Boats Content
